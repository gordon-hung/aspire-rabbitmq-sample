...
public class RabbitMqTopicSecondBackgroundService(
    ILogger<RabbitMqTopicSecondBackgroundService> logger,
    IConnection connection) : BackgroundService
{
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        return Task.Run(() =>
        {
            ...
            var queueName = "amqp.topic.queue.second";
            var routingKeyName = "amqp.topic.routingkey.*";
